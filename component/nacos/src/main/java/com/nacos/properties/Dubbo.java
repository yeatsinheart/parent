...
public class Dubbo {
    ...
    public static String get(String connect) {
        return "dubbo.scan.base-packages=service.tenantservices.impls,service.userservices.impls,service.cmsservices.impls,service.busservices.impls,service.costservices.impls,service.payservices.impls,service.gameservices.impls,service.reportservices.impls,com.gateway.Notify\n" +
                "dubbo.consumer.check=false\n" +
                "dubbo.protocol.name=dubbo\n" +
                "dubbo.protocol.port=-1\n" +
                "## Dubbo Registry ?backup=\n" +
