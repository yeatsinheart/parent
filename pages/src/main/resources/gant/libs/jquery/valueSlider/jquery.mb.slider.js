    ...
    $.mbSlider = {
        ...
        buildSlider: function (options) {
            return this.each(function () {
                ...
                slider.sliderZeroLabel = $("<div class='mb_sliderZeroLabel'>0</div>").css({
                    position: "absolute",
                    top: (slider.options.labelPos == "top" ? -18 : 29)
                });
                slider.sliderValueLabel = $("<div class='mb_sliderValueLabel'/>").css({
                    position: "absolute",
                    borderTop: "2px solid " + slider.options.rangeColor
                });
        ...
        setVal: function (val) {
            ...
            if (slider.evalPosGrid >= 0) {
                ...
                slider.sliderRange.css({
                    left: 0,
                    width: posInGrid,
                    background: slider.options.rangeColor
                ...
                slider.sliderRange.css({
                    left: 0,
                    width: slider.zero,
                    background: slider.options.negativeColor
                }).addClass("negative");
