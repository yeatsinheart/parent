export default class API {
  ...
  static getRequest(apiId, version, param,cacheable,cacheTime ) {
    let api = {};
    let language = localStorage.getItem('choosed-language') || localStorage.getItem('application-default-language') || process.env.VUE_APP_DEFAULT_LANGUAGE
    let currency = localStorage.getItem('choosed-currency') || localStorage.getItem('application-default-currency') || process.env.VUE_APP_DEFAULT_CURRENCY
